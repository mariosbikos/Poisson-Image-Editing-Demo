...
%%
%Build vector b (size(Mask_Source_1D_Indices) x 3)
...
for i=1:size(Mask_Source_1D_Indices,1)
    ...
    for channel=1:3
        b(i,channel)=...
            SumOfNeighbors( MaskOfTarget_indices(i),targetImg_1D(:,channel),MaskOfTarget_1D,height_MaskOfTarget )+...
            SumOfLaplacians( Mask_Source_1D_Indices(i),srcImg_1D(:,channel),height_MaskOfSource );
    end
end
close(Bwait);
...
imwrite(newTargetImg,'Result_4a_Image.png')
print(res_fig,'Result_4a_Figure','-dpng')
