...
for i=1:size(Mask_Source_1D_Indices,1)
    ...
    b(i)=SumOfNeighbors( MaskOfTarget_indices(i),targetImg_1D,MaskOfTarget_1D,height_MaskOfTarget )+...
        SumOfMixingGradients(Mask_Source_1D_Indices(i),srcImg_1D,height_MaskOfSource,MaskOfTarget_indices(i),...
        targetImg_1D,height_MaskOfTarget);
end
close(Bwait);
...
imwrite(newTargetImg,'Result_3b_Image.png')
print(res_fig,'Result_3b_Figure','-dpng')
